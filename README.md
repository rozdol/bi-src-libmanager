...
```bash
curl -H "Content-Type: application/json" -H "Accept: application/json" -X POST -d '{"user":"admin","pass":"Pass1234"}' http://is.local.lan/\?act\=api


curl -H "Content-Type: application/json" -H "Accept: application/json" -H "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOjIsInVubSI6ImFkbWluIiwiZXhwIjoxNTUwNTY4NTI5fQ.pWihHlFaIHU98u8ovHFUJC5kXDnw8p8XJ6_SWxhg8BE" -X POST -d '{"user":"admin", "api_key":"87b101-1bdadf-0b2e36-513838-8b3005", "func":"show", "table":"books"}' http://is.local.lan/\?act\=api
```
