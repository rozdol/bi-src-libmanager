...
$out.="<tr><td class='mr'><b>Books transaction id: </b></td><td class='mt'>$res[books_transaction_id]</td></tr>";
...
$out.="<tr><td class='mr'><b>Text: </b></td><td class='mt'>$res[text]</td></tr>";
$out.="</table>";
